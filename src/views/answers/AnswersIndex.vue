      ...
      <template #header>
        <h2>
          ...
          <el-button
            type="text"
            icon="el-icon-plus"
            @click="$router.push({ name: 'papers_add' })"
            >添加</el-button>
        </h2>
      </template>
        ...
        <el-table-column label="操作">
          <template #default="{ row }">
            ...
            <el-button
              type="text"
              icon="el-icon-edit"
              @click="$router.push({ path: `/papers/edit/${row._id}` })"
              >编辑</el-button
            >
            <el-button
              type="text"
              @click="$router.push({ path: `/papers/answers/add/${row._id}` })"
              >发布</el-button
            >
            <el-button
              type="text"
              @click="$router.push({ path: `/items/edit/${row._id}` })"
              >查看</el-button
            >
